...
import de.unistuttgart.iste.gits.quiz_service.persistence.dao.NumericQuestionEntity;
...
class MutateQuizUpdateNumericQuestionTest {
    ...
    void testUpdateNumericQuestion(GraphQlTester graphQlTester) {
        ...
        graphQlTester.document(query)
                ...
                .path("mutateQuiz.updateNumericQuestion.questionPool[0].text.text").entity(String.class).isEqualTo("new question")
                .path("mutateQuiz.updateNumericQuestion.questionPool[0].hint.text").entity(String.class).isEqualTo("new hint")
