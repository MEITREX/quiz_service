...
import de.unistuttgart.iste.gits.quiz_service.persistence.dao.SelfAssessmentQuestionEntity;
...
class MutateQuizUpdateSelfAssessmentQuestionTest {
    ...
    void testUpdateSelfAssessmentQuestion(GraphQlTester graphQlTester) {
        ...
        UpdateSelfAssessmentQuestionInput input = UpdateSelfAssessmentQuestionInput.builder()
                ...
                .setSolutionSuggestion(new ResourceMarkdownInput("new solution suggestion"))
                .build();
        ...
        graphQlTester.document(query)
                ...
                .path("mutateQuiz.updateSelfAssessmentQuestion.questionPool[0].text.text").entity(String.class).isEqualTo("new question")
                .path("mutateQuiz.updateSelfAssessmentQuestion.questionPool[0].hint.text").entity(String.class).isEqualTo("new hint")
                .path("mutateQuiz.updateSelfAssessmentQuestion.questionPool[0].solutionSuggestion.text").entity(String.class).isEqualTo("new solution suggestion");
        ...
        assertThat(updatedQuestion.getSolutionSuggestion().getText(), is("new solution suggestion"));
    }
}
